...
$lang = array_merge($lang, array(
	...
	'GOTHICK_RECAPTCHA2_POST_CONFIRM_EXPLAIN' 	=> 'Afin d’empêcher les créations de comptes automatisées, le forum vous demande de confirmer que vous êtes un humain. Si vous n’avez pas la faculté ou la possibilité d’effectuer la tâche ci-dessous, veuillez contacter le %sBoard Administrator%s.',

	'GOTHICK_RECAPTCHA2_CONFIRM_HUMAN'			=> 'Veuillez confirmer que vous êtes un humain',
	'GOTHICK_RECAPTCHA2_EXPLAIN'				=> 'Afin d’empêcher les créations de comptes automatisées, merci de saisir les deux mots affichés dans le champ texte ci-contre.',
